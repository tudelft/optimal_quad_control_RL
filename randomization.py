...
randomization_standard10_percent = lambda num: {key: np.random.uniform(value*0.9, value*1.1, num) if key != 'k' else np.random.uniform(value*0.9, min(value*1.1, 1), num) for key, value in params_standard.items()}
# 20% randomization
